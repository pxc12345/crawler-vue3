...
def register():
    try:
        ...
        print(f'注册错误: {e}', file=sys.stderr)
        return jsonify({
            'success': False,
            'message': '注册失败',
...
def login():
    try:
        ...
        print(f'登录错误: {e}', file=sys.stderr)
        return jsonify({
            'success': False,
            'message': '登录失败',
            'code': 'LOGIN_FAILED',
...
def refresh_token():
    try:
        ...
        print(f'刷新Token错误: {e}', file=sys.stderr)
        return jsonify({
            'success': False,
            'message': '刷新Token失败',
            'code': 'REFRESH_FAILED',
...
def logout():
    try:
        ...
        print(f'登出错误: {e}', file=sys.stderr)
        return jsonify({
            'success': False,
            'message': '登出失败',
            'code': 'LOGOUT_FAILED',
...
def send_forgot_password_code():
    try:
        ...
        print(f'发送验证码错误: {e}', file=sys.stderr)
        return jsonify({
            'success': False,
            'message': '发送验证码失败',
...
def verify_forgot_password_code():
    try:
        ...
        print(f'验证验证码错误: {e}', file=sys.stderr)
        return jsonify({
            'success': False,
            'message': '验证失败',
            'code': 'VERIFY_FAILED',
...
def reset_password():
    try:
        ...
        print(f'重置密码错误: {e}', file=sys.stderr)
        return jsonify({
            'success': False,
            'message': '重置密码失败',
            'code': 'RESET_FAILED',
...
def change_password():
    try:
        ...
        print(f'修改密码错误: {e}', file=sys.stderr)
        return jsonify({
            'success': False,
            'message': '修改密码失败',
            'code': 'CHANGE_FAILED',
...
def get_profile():
    try:
        ...
        print(f'获取用户信息错误: {e}', file=sys.stderr)
        return jsonify({
            'success': False,
            'message': '获取用户信息失败',
