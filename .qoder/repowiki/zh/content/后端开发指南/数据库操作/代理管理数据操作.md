...
- [app.py:1246-1553](file://python/app.py#L1246-L1553)
...
- [app.py:1510-1551](file://python/app.py#L1510-L1551)
...
## 附录
- 代理查询与管理API使用示例（路径）
  - 获取代理列表：[GET /api/proxy/list:1248-1260](file://python/app.py#L1248-L1260)
  - 新增代理：[POST /api/proxy/add:1262-1300](file://python/app.py#L1262-L1300)
  - 删除代理：[DELETE /api/proxy/{proxy_id}:1302-1314](file://python/app.py#L1302-L1314)
  - 刷新代理：[POST /api/proxy/{proxy_id}/refresh:1316-1328](file://python/app.py#L1316-L1328)
  - 获取代理分组：[GET /api/proxy/groups:1330-1342](file://python/app.py#L1330-L1342)
  - 创建代理分组：[POST /api/proxy/groups:1344-1371](file://python/app.py#L1344-L1371)
  - 分组分配代理：[POST /api/proxy/groups/assign:1373-1394](file://python/app.py#L1373-L1394)
  - 获取黑名单：[GET /api/proxy/blacklist:1396-1408](file://python/app.py#L1396-L1408)
  - 添加黑名单：[POST /api/proxy/blacklist:1410-1437](file://python/app.py#L1410-L1437)
  - 移除黑名单：[DELETE /api/proxy/blacklist/{item_id}:1439-1451](file://python/app.py#L1439-L1451)
  - 获取白名单：[GET /api/proxy/whitelist:1453-1465](file://python/app.py#L1453-L1465)
  - 添加白名单：[POST /api/proxy/whitelist:1467-1494](file://python/app.py#L1467-L1494)
  - 移除白名单：[DELETE /api/proxy/whitelist/{item_id}:1496-1508](file://python/app.py#L1496-L1508)
  - 获取速率限制：[GET /api/proxy/rate-limits:1510-1522](file://python/app.py#L1510-L1522)
  - 设置速率限制：[POST /api/proxy/rate-limits:1524-1551](file://python/app.py#L1524-L1551)